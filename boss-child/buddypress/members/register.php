...
<div id="buddypress">
	...
	// Check if registration code parameter exists
	if( !isset( $_GET['code'] ) ): // if parameter is not set in the URL
		...
		<script>
			...
			input.addEventListener( 'click', function(e){
				...
				if(input) {
					window.location.href = '/register/?code=' + input;
				}
			});
		</script>
		<?php
		...
		// WP_Query arguments
		$args = array(
			'post_type'              => array( 'registration-code' ),
			...
			if( $limit == 0 ) {
				...
				<div class="page" id="register-page">
					...
					<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
						...
						<div class="submit">
							<input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Submit', 'buddypress' ); ?>" />
						</div>
					...
					<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
						...
						$new_limit = $limit - 1;
						update_field( 'limit', $new_limit, $code_id );
